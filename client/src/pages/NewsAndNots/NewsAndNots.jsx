...
const NewsAndNots = () => {
  ...
  const getAllNewsAndNots = async () => {
    ...
    let res = await fetch(
      "https://nusocial5.herokuapp.com/api/friends/getAllFriendRequestsPending",
      settings
    );
    ...
    arr.forEach((stu) => {
      ...
      if (stu[0] === "sent") {
        ...
        fetch(
          ...
          .then((data) => {
            ...
            setAllNews((list) => [
              ...
              [
                stu,
                "You sent " + stu[1] + " a friend request at" + stu[2],
                "View " + stu[1] + "'s profile",
                pic,
              ],
            ]);
          });
        ...
        setAllNews((list) => [
          ...list,
          [stu, "Dummy message", "ButtonMsg", pic],
        ]);
      }
    });
  };
  ...
  const confirmFriendRequest = (friendUsername) => {
    ...
    fetch("https://nusocial5.herokuapp.com/api/friends/confirmFriend", settings)
